...
public class ProductInventory {
	 ...
	 * @param code
	 * a barcode
	 * @return the barcoded product with the matching barcode, null if it doesnt exist
	 */
	 ...
	 * @param code
	 * a plu
	 * @return the plu coded product with the matching plu, null if it doesn't exist.
	 */
