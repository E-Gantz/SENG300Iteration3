...
/**
 * This class contains a hashmap which is used to contain giftcard information. Only gift card numbers, card balance
 * and card activation status is contained in the hashmap.
 */
public class GiftCardDatabase {
	...
	/**
	 *This method takes in a card number parameter and verifies if it exists in the hashmap
	 *
	 * @param cardnumber
	 */
	...
	/**
	 *This method takes in a card number parameter and verifies it has been redeemed
	 *
	 * @param gcnumber
	 */
	...
	/**
	 *This method takes in a card number parameter and uses it as the key to find the giftcard balance in the hashmap
	 *
	 * @param cardnumber
	 */
	...
	/**
	 *This method takes in a card number parameter and uses it as the key to change the status in
	 * the hashmap
	 *
	 * @param gcnumber
	 */
	...
	/**
	 *This method takes in a card number parameter and a BigDecimal value to update the card balance in the hashmap
	 * using the card number as the key
	 *
	 * @param gcnumber
	...
	/**
	 *This method takes in a card number parameter and a BigDecimal value and creates a new entry in the hashmap
	 * which is to be used in testing
	 *
	 * @param gcnumber
	 * @param Balance
	 */
