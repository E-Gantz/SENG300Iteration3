...
/**
 * This class is allows attendants to refill the dispensers in the selfcheckout system and manages the printer & ink 
 * quantities inside the selfcheckout machine
 */
public class AttendantRefillsDispensers{
    ...
    /**
     *  getter method to obtain the current size of the coinDispenser
     *  and returns an int
     *  
     *  @param coinDispenser
    ...
    /**
     *  getter method to obtain the current size of the banknoteDispenser
     *  and returns an int
     *  
    ...
    /**
     *  This method refills the coin dispenser using a coin object and the amount that is needed to be filled as 
     *  a parameter
     *  
     *  @param coinDispenser
     *  @param coins
    ...
    /**
     *  This method refills the banknote Dispenser using a banknote object and the amount that is needed to be filled as 
     *  a parameter
     *  
     *  @param banknoteDispenser
     *  @param banknotes
