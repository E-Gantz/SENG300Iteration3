...
/**
 * This class is responsible to adding new attendants into the hashmap and validates which attendants are able to 
 * able to log into the attendant system
 */
public class AttendantData {
    ...
    /**
     * This method removes an attendant from the hashmap given the username as a parameter
     * 
     * @param username
     * 
     */
    ...
    /**
     * This method allows an attendant to log into the selfcheckoutsystem using their username & password as parameters
     * passed in and then returns a true or false response
     * 
     * @param username
     * @param password
     * @return true
