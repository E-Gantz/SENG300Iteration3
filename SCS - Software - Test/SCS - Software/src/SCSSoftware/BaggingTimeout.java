...
/**
 * a timer task to facilitate checking if the user has placed their item in the bagging area every .5 seconds for 5 seconds
 */
public class BaggingTimeout extends TimerTask{
	...
	/**
	 * if the bagging area contains the expected weight of all items in the cart, then cancel the timer.
	 * otherwise, run the timer until 5 seconds has passed, then set the not in bags flag in the placer
	 */
	public void run() {
		counter++;
		if (counter == 10) {
